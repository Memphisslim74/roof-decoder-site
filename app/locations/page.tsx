...
export const metadata: Metadata = {
  title: "Northern Colorado Roof Quote Help | Five Local City Guides",
  description: "Local roof quote, hail damage, Class 4 shingle, and roof replacement guidance for homeowners in Berthoud, Loveland, Fort Collins, Greeley, and Boulder, Colorado.",
};

export default function LocationsPage() {
  return (
    <PageShell>
      <section className="page-hero page-hero-light"><div className="container narrow-hero"><p className="eyebrow">Northern Colorado service areas</p><h1>Local Roof Guidance Where It Matters Most</h1><p>We focus this resource on five Front Range communities so every city guide can be useful, specific, and supported by a genuinely local roofing team.</p></div></section>
