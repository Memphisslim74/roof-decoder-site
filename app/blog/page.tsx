...
export const metadata: Metadata = {
  ...
  description: "Practical roofing guides for Berthoud, Loveland, and Fort Collins homeowners covering roof quotes, hail damage, Class 4 shingles, and insurance-related scope.",
};
