...
export default function BlogPage() {
  return (
    <PageShell>
      <section className="page-hero page-hero-light"><div className="container narrow-hero"><p className="eyebrow">Northern Colorado roofing guides</p><h1>Northern Colorado Roofing Articles</h1><p>Clear, useful articles for homeowners comparing estimates, responding to hail, evaluating materials, and navigating the roofing side of an insurance claim.</p></div></section>
